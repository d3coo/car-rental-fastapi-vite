...
from ..base import Entity, ValidationError, BusinessRuleViolation
...
class Contract(Entity):
    ...
    def can_extend(self) -> bool:
        ...
        return (
            ...
            self.payment_status in [PaymentStatus.PAID, PaymentStatus.PARTIAL]
        )
    ...
    def complete(self) -> None:
        ...
        if self.status not in [ContractStatus.ACTIVE, ContractStatus.EXTENDED]:
            raise BusinessRuleViolation("Only active or extended contracts can be completed")
    ...
    def update_payment_status(
        ...
        if self.status == ContractStatus.CANCELLED:
            raise BusinessRuleViolation("Cannot update payment status of cancelled contract")
    ...
    def is_overdue(self) -> bool:
        ...
        return (
            self.status in [ContractStatus.ACTIVE, ContractStatus.EXTENDED] and
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            } if self.transaction_info else None,
            'listExtendDetails': [
                {
            ...
            ] if self.extension_history else []
        }